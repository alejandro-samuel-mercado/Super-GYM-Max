  ...
  return (
    <div id="features" className="px-4 md:px-16 lg:px-24 xl:px-32">
      ...
      <div className="mt-40 relative mx-auto max-w-5xl">
        ...
        >
          SuperGYMAX te ayuda a transformar tu físico y salud con programas
          personalizados y una comunidad que te empuja a superarte.
        </motion.p>
        <div className="grid grid-cols-1 md:grid-cols-3 mt-8 gap-10">
          ...
          >
            ...
            <h3 className="text-[24px]/7.5 text-slate-300 font-medium mt-6">
              Mejor diseño para tu mejor performance
            </h3>
            <p className="text-slate-300 mt-2">
              Nuestras instalaciones están diseñadas para inspirarte en cada
              sesión.
            </p>
            <a
              href="#pricing"
